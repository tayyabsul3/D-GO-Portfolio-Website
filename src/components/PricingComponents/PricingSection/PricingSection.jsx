      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
          ...
          <div className="sm:p-8 p-4 hover:shadow-lg rounded-xl transition-all">
            <h2 className="text-3xl font-bold text-gray-800 mb-4 mt-1">
              Basic
            </h2>
            ...
            <button className="w-full border-2 rounded-lg border-red-800 py-3 mb-8 text-red-800 transition">
              Get Started Now
            </button>
          ...
          <div className="bg-red-800 rounded-xl  p-8 hover:shadow-lg transition-all">
            ...
            <button className="w-full bg-white text-red-800 rounded-lg py-3 mb-8">
              Get Started Now
            </button>
          ...
          <div className="sm:p-8 p-4 hover:shadow-lg rounded-xl transition-all">
            ...
            <button className="w-full rounded-lg border-2 border-red-800 bg-white text-red-800 py-3 mb-8">
              Get Started Now
            </button>
