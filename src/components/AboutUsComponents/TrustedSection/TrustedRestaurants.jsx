    ...
    return (
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-medium text-gray-800">Urbair Restaurant</h3>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-medium text-gray-800">Gulf Restaurant</h3>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-medium text-gray-800">Spicy Restaurant</h3>
            </div>
            </div>
        </div>
        </div>
