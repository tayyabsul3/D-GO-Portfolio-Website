...
const TrustedRestaurants = () => {
    return (
        <div className="py-12 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: 'rgb(254, 249, 238)' }}>
        <div className="max-w-7xl mx-auto">
            {/* Section Title */}
            <h2 className="text-3xl sm:text-3xl font-semibold text-center text-gray-900 mb-12">
            ...
            <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-medium text-gray-800">Independent Cafés & Eateries</h3>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-medium text-gray-800">Multi-Branch Chains</h3>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-medium text-gray-800">Franchise Operators</h3>
            </div>
            </div>
        </div>
        </div>
