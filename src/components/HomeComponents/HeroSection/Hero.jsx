...
const HeroSection = () => {
    return (
        <div className="relative" style={{ backgroundColor: 'rgb(248, 245, 240)' }}>
            <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row">
                    {/* Left side - Text content */}
                    <div className="lg:w-1/2 lg:pr-10 py-12 sm:py-16 lg:py-20 ml-12">
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold text-gray-900 leading-tight mb-8">
                            Run your business,<br />
                            not your<span className='text-red-800'> tech<br /></span>
                        </h1>
                        
                        <p className="text-base text-gray-600 mb-10">
                            D-Go is an all-in-one restaurant management platform that unifies POS, QR ordering, <br />
                            inventory, branding, and AI voice agents — no tech expertise needed
                        </p>
                    ...
                    <div className="lg:w-1/2 lg:absolute lg:right-0 lg:top-0 lg:h-full lg:overflow-hidden relative">
                        {/* Main image */}
                        <img 
                            src={restaurantImage} 
